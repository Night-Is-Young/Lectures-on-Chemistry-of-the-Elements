...
\begin{enumerate}[label=\tbf{\arabic*},topsep=0pt,parsep=0pt,itemsep=0pt,partopsep=0pt]
        ...
        \begin{figure}[H]
            ...
            \subfigure[\ce{H7O3+}]
            {
                \begin{minipage}[b]{.45\linewidth}
                    \centering\includegraphics[scale=0.25]{picture/H7O3+.eps}
                \end{minipage}
            }
            \subfigure[\ce{H9O4+}]
            {
                \begin{minipage}[b]{.45\linewidth}
                    \centering\includegraphics[scale=0.25]{picture/H9O4+.eps}
                \end{minipage}
            }
    ...
    \item \ce{H13O6+}.它最初被发现于笼状阳离子\ce{[(C9H18)3(NH)2Cl]^+}在盐酸溶液析出的结晶中.该固体中的\ce{H13O6+}被周围的\ce{Cl-}离子所稳定.下面是该笼状阳离子结构和水合氢离子的结构.
        \begin{figure}[H]
            \centering\includegraphics[scale=0.25]{picture/H13O6+.eps}
