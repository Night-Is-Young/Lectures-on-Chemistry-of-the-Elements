...
\begin{figure}[H]
    ...
    \subfigure[\ce{Te4Cl16}的结构]{
        \begin{minipage}[b]{.45\linewidth}
            \centering\includegraphics[scale=0.75]{picture/Te4Cl16.eps}
        \end{minipage}
    }
    \subfigure[\ce{Te3Cl^-_13}的结构]{
        \begin{minipage}[b]{.45\linewidth}
            \centering\includegraphics[scale=0.75]{picture/Te3Cl13.eps}
        \end{minipage}
    }
    \subfigure[\ce{Te2Cl^2-_10}的结构]{
        \begin{minipage}[b]{.45\linewidth}
            \centering\includegraphics[scale=0.75]{picture/Te2Cl10.eps}
        \end{minipage}
    }
