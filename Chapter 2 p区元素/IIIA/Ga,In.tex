...
似乎没什么可说的.它们的稳定性介于\ce{GaF}和\ce{GaI}之间.通常,它们在溶液中是亚稳态的,一旦温度稍高就会发生歧化.\ce{GaCl},\ce{GaBr}和\ce{GaI}经常被用于制备\ce{Ga}的团簇和金属有机化合物.
...
事实上,\ce{MX2}\footnote{这里$\ce{M}=\ce{Ga},\ce{In}$,$\ce{X}=\ce{Cl},\ce{Br},\ce{I}$.在不引起歧义的情况下,下同.}是成分为\ce{M^{I}[M^{III}X4]}的稳定的离子化合物.像\ce{B2X4}那样形成\ce{M-M}键对这些元素毕竟还是太弱,不如采取混合价态.将\ce{MX}与\ce{AlX3}等Lewis酸反应也可以得到类似成分的\ce{[M]+[AlX4]-}等物质.\ce{GaX2}本身也可以和各种配体反应生成\ce{[GaL4]+[GaX4]-}这样的物质.
\paragraph{低卤化物的衍生物}
在各种\ce{MX2}的衍生物中,就普遍地存在含\ce{M-M}键的\ce{G2X4}结构单元,这些化合物中的\ce{M}不再是混合价态的,而是均为$+2$价.例如,\ce{Ga2Br4py2}的结构如下所示:
\chemfig{Ga2Br4py2}{1}{\ce{Ga2Br4py2}的结构}
此外,用\ce{X-}的盐处理\ce{MX2}即可得到\ce{[M2X6]^2-}的盐:
\begin{center}
    \ce{2Et4NCl + M2X4 -> [NEt4]2[M2X6]}
\end{center}
它们的结构与前面提到的\ce{[Ga2I6]^2-}是相似的,这里就不再重绘了.
\subsection{镓,铟的氧化物和氢氧化物}
对于镓,铟的氧化物和氢氧化物的研究则少得多.大体而言,它们与\ce{Al}一样能形成\ce{M2O3},\ce{M(OH)3}和\ce{MO(OH)}等化合物,并且相互之间可以通过加热等方式互相转化.主要的区别在于\ce{Ga}的氧化物和氢氧化物是两性的,而\ce{In}的类似物则是碱性的.
\subsection{镓,铟的金属有机化合物及簇合物}
我们在前面提到,\ce{GaBr}和\ce{GaI}可以作为各种簇合物\footnote{有关\ce{Ga}和\ce{Al}的更多簇合物可以参考H. Schnöckel, \textit{Chem. Rev}. \tbf{2010}, \textit{110}, 4125-4163, https://doi.org/10.1021/cr900375g.}和金属有机化合物的合成前体.
\subsubsection{低价卤化物的簇合物}
将\ce{Li[Si(TMS)3]}(记为\ce{LiR})加入\ce{GaBr}的\ce{THF}溶液中,即可得到一系列复杂的物质:
\begin{center}
    \ce{LiR + GaBr ->T[THF] R2GaBr2Li(THF)2, Ga4Br4R4,Ga22R8,$\cdots$}
\end{center}
前两者的结构如下所示.
\bichemfig{R2GaBr2Li(THF)2}{1}{\ce{R2GaBr2Li(THF)2}的结构}{Ga4Br4R4}{1}{\ce{Ga4Br4R4}的结构}{\ce{GaBr}与\ce{LiSi(TMS)3}反应的部分产物}
\noindent 而\ce{Ga22R8}的结构更是抽象.它由中心的\ce{\{Ga14\}}核以及外部的八个\ce{GaR}取代基组成.内部的\ce{\{Ga14\}}核的结构如下:
\chemfig{Ga14}{1}{\ce{Ga22R8}中的\ce{\{Ga13\}}核的结构}
\noindent 每个四边形面都对应一个\ce{GaR}基团的配位.
\subsection{金属有机化合物}
自1980年以来,人们对Ga,In的金属有机化合物产生了兴趣,主要是因为它们可用作GaAs和InP等半导体材料的前体.
\subsubsection{三价金属有机化合物}
三烷基镓或铟\ce{R3M}可以通过卤化物和Grignard试剂,烷基锂试剂或单质与烷基汞试剂的反应来制备:
\begin{center}
    \ce{MBr3 + 3RMgBr ->T[\ce{Et2O}] R3M + 3MgBr2}\\
    \ce{MCl3 + 3RLi ->T[hexane] R3M + 3LiCl}\\
    \ce{2M + 3HgR2 -> 2R3M + 3Hg}
\end{center}
三芳基镓或铟\ce{Ar3M}的制备也是类似的.这些化合物可以用于气相沉积法制备半导体材料薄膜,例如:
\begin{center}
    \ce{Me3Ga(g) + AsH3(g) ->T[$1000\K$] GaAs(s) + 3CH4(g)}
\end{center}
三烷基或三芳基\ce{Ga,In},在溶液和气相中均为单体,这与\ce{BR3}和\ce{BAr3}类似,其中的金属中心为平面三角形的配位构型.不过在固体中,总能观察到分子间的\ce{C-M}相互作用,例如在\ce{Me3In}中存在的四聚体单元\ce{[Me3In]4}.与炔基\ce{Al}配合物类似的二聚体\ce{[Me2Ga(C#CPh)]2}也是存在的.
\bichemfig{InMe3}{1}{\ce{[Me3In]4}的结构}{Me2GaCCPh}{1}{\ce{Me2Ga(CCPh)}的结构}{部分烷基镓/铟化合物的结构}
不难想见,这些化合物也容易接受配位.一个特殊的例子是\ce{GaN(C3H6)3},其中的五元环限制了\ce{Ga}形成四面体的配位构型,因此其中的\ce{Ga}与三个\ce{C}事实上是共平面的.
\chemfig{GaN(C3H6)3}{1}{\ce{GaN(C3H6)3}的结构}
\subsubsection{低价金属有机化合物}
使用大位阻的\ce{R}基团(例如\ce{CH(TMS)2},\ce{Dipp}等)可以制得含有\ce{M-M}键的\ce{M2R4}.使用更大位阻的\ce{R}基团则可以得到\ce{GaR}的单体和二聚体.
\bichemfig{GaR}{1}{\ce{GaR}中的\ce{R}基团}{Ga2R2}{1}{\ce{Ga2R2}中的\ce{R}基团}{\ce{GaR}及二聚体中\ce{R}的结构}
\ce{Ga2R2}可以进一步被\ce{Na}单质还原为\ce{Na2[Ga2R2]},其中的\ce{Ga-Ga}键进一步缩短,并且和其等电子体\ce{RGe#GeR}一样具有折线形结构.\\
\indent 传统的价键理论应当可以将上面两种物质解释为\ce{RGa=GaR}和\ce{[RGa#GaR]^2-},后者因为键级更大而键长更短.然而,高周期元素的$\pi$键并不容易形成,已经有很多研究表明后者中较短的\ce{Ga-Ga}距离是因为\ce{Ga-Na-Ga}静电作用所致.
\subsubsection{有机镓簇合物}
\indent 用\ce{Na}单质还原\ce{(2,6-Mes_2C6H3)GaCl2}即可得到环状的负离子\ce{[(2,6-Mes_2C6H3)3Ga3]^2-},这一负离子是一个$2\pi$电子的芳香体系.
\chemfig{Ga32-}{1}{\ce{[(2,6-Mes_2C6H3)3Ga3]^2-}的结构}
前面已经说过,我们经常用\ce{GaBr}制备各种含\ce{Ga}的有机团簇.例如,在$195\K$下将\ce{GaBr}与\ce{LiC(TMS)3}在甲苯中反应的产物之一为\ce{Ga8(C(TMS)3)6},其结构为两个相连的\ce{\{Ga4\}}四面体:
\chemfig{Ga8R6}{1}{\ce{Ga8(C(TMS)3)6}的结构}
\end{document}