...
\subsubsection{一卤化物\ce{AlX}}
\ce{Al}的一卤化物仅在气相中以分子的形式短暂存在.这是因为\ce{AlX3}的强大的稳定性使得它们在凝聚相中容易发生歧化:
\begin{center}
    \ce{3AlX -> 2Al + AlX3}
\end{center}
通常而言,制备\ce{Al}的一卤化物可以在高温下将\ce{Al}与\ce{HX}反应后迅速冷却得到.
\subsubsection{铝的低价态卤化物及簇合物}
\ce{AlBr}在低温下与\ce{PhOMe}反应后升温即可得到含有\ce{Al-Al}键的\ce{Al2Br4(PhOMe)2}.从\ce{AlI}的\ce{THF/PhMe}亚稳态溶液中得到的沉淀\ce{Al2I4(THF)2}也具有类似的结构,示意如下:
\bichemfig{Al2Br4(PhOMe)2}{1}{\ce{Al2Br4(PhOMe)2}的结构}{Al2I4(THF)2}{1}{\ce{Al2I4(THF)2}的结构}{含有\ce{Al^{II}}的几种化合物的结构}
控制条件还可以得到更复杂的产物.\ce{AlBr}在\ce{THF/PhMe}中可以沉淀得到\ce{Al22Br20(THF)12}和\ce{Al10Br14(THF)10}.前者中具有一个\ce{\{Al12\}}二十面体核心,除相对的两个顶点由\ce{THF}直接配位外,其余十个\ce{Al}都被\ce{AlBr2(THF)}基团配位.这一簇合物事实上和\ce{B10C2H12}是等电子体.
\chemfig{Al22Br20(THF)12}{1}{\ce{Al22Br20(THF)12}的结构示意图}
\noindent 而\ce{Al10Br14(THF)10}事实上是离子化合物\ce{[Al5Br6(THF)6]+[Al5Br8(THF)4]-},正负离子的结构如下所示:
\bichemfig{[Al5Br6(THF)6]+}{1}{\ce{[Al5Br6(THF)6]+}的结构}{[Al5Br8(THF)4]-}{1}{\ce{[Al5Br8(THF)4]-}的结构}{\ce{Al10Br14(THF)10}中的两种离子}
\subsubsection{\ce{AlF3}及其衍生物}
...
\end{center}
\subsubsection{\ce{AlBr3}与\ce{AlI3}}
...
铝的三烷基化合物和三芳基化合物是高度活性的,无色的易挥发液体或是能在空气中自燃的低熔点固体,若遇水则激烈反应,所以应谨慎使用并作好适当的预防措施.这些化合物与\ce{BR3}和\ce{BAr3}不同,它们常常以二聚体的形式存在.炔基阴离子的配合物的桥连方式有些特别,似乎是对一个\ce{Al}直接配位,对另一个\ce{Al}进行侧基配位.
\bichemfig{Al2Me6}{1}{\ce{AlMe3}的二聚体结构}{Ph2AlCCPh}{1}{\ce{Ph2AlCCPh}的二聚体结构}{三价铝的部分金属有机化合物}
\subsubsection{含\ce{Al-Al}键的金属有机化合物}
第一个\ce{R2Al-AlR2}是由如下反应制得的:
\begin{center}
    \ce{2((TMS)2CH)2AlCl + 2K -> 2KCl + [((TMS)2CH)2Al]2}
\end{center}
除了像\ce{B2R4}那样的对称的结构外,事实上还能形成非对称的结构,例如\ce{CpAlAl(C6F5)3}.这是一个电荷分离的物种,其中的\ce{Al-Al}键也相应的更短一些.
\bichemfig{Al2R4}{1}{\ce{Al2R4}的结构(其中$\ce{R}=\ce{HC(TMS)2}$)}{CpAlAl(C6F5)3}{1}{\ce{CpAlAl(C6F5)3}的结构}{含\ce{Al-Al}键的部分金属有机化合物}
\subsubsection{铝的茂基配合物}
本节选取了一些有趣的茂基铝化合物的合成与结构\footnote{Dabringhaus, P., Willrett, J., Krossing, I. Synthesis of a low-valent \ce{Al4+} cluster cation salt. \textit{Nat. Chem.} \tbf{14}, \textit{1151-1157} (2022). https://doi.org/10.1038/s41557-022-01000-4},以供参考.\\
\indent 控制\ce{AlCl3}与\ce{TMSCp*}按$1:1$的计量比反应即可得到\ce{[Cp^{*}]-}对\ce{Al}配位的\ce{[Cp^{*}AlCl2]2}.用\ce{K}单质还原\ce{[Cp^{*}AlCl2]2}即可得到四面体构型的\ce{[AlCp^{*}]4}.值得一提的是,其它\ce{Al4R4}四面体笼也可以通过碱金属还原\ce{[RAlCl2]2}得到.
\bichemfig{[CpAlCl2]2}{1}{\ce{[Cp^{*}AlCl2]2}的结构}{Al4Cp4}{1}{\ce{[AlCp^{*}]4}的结构}{铝的茂基配合物I}
\ce{[AlCp^{*}]4}与\ce{LiPF6}发生$1:1$反应,脱去\ce{LiCp^{*}}即可得到\ce{[Al(AlCp^{*})3]+},可视作三个\ce{CpAl^{*}}基团对中心\ce{Al^+}配位,因而所有原子都满足八电子构型,并且中心的\ce{Al}采取三角锥的配位构型.在较浓的溶液中,该离子以二聚体的形式存在.
\bichemfig{Al4Cp3+}{1}{\ce{[Al(AlCp^{*})3]+}的结构}{Al8Cp62+}{1}{\ce{[Al2(AlCp^{*})6]2+}的结构}{铝的茂基配合物II}
在较稀的\ce{[Al(AlCp^{*})3]+}溶液中加入$1,3-$二氟苯,即可得到夹心配合物\ce{[Cp^*(Al(AlCp^{*})3)2]+[PF6]-},阳离子的结构如下所示:
\chemfig{Al8Cp7+}{1}{\ce{[Cp^*(Al(AlCp^{*})3)2]+}的结构}
然而,在较浓的溶液中加入$1,3-$二氟苯则会使该离子发生歧化:
\begin{center}
    \ce{2[Al2(AlCp^{*})6][PF6]2 -> [AlCp^{*}]4 + 8Al + 4[Al(Cp^{*})2][PF6]}
\end{center}
\subsection{铝氮化合物}
最后,我们把注意力转向到一个值得研究的范围,即含有各种顺序\ce{Al-N}键的杂环和簇状有机金属化合物上.\\
\indent 甲胺和三甲基铝的加合物\ce{Me3Al(NH2Me)}在不同温度下的分解将给出不同结构的产物:
\begin{center}
    \ce{21Me3Al(NH2Me) ->T[$70\tc$][$-21\ce{CH4}$] 7(Me2AlNHMe)3 ->T[$215\tc$][$-21\ce{CH4}$] 3(MeAlNMe)7}
\end{center}
两种产物的结构如下所示\footnote{事实上\ce{(Me2AlNHMe)3}有顺反两种异构体.}.
\bichemfig{(Me2AlNHMe)3}{1}{\ce{(Me2AlNHMe)3}的结构}{(MeAlNMe)7}{1}{\ce{(MeAlNMe)7}的结构}{\ce{Me3Al(NH2Me)}分解产物的结构}
改变\ce{Al}和\ce{N}上的基团以及反应条件,还可以得到以下簇合物:
\begin{figure}[H]
    \centering
    \subfigure[\ce{(MeAlN^{$i$}Pr)4}的结构]{
        \begin{minipage}[b]{.3\linewidth}
            \centering\includegraphics{picture/(MeAlNiPr)4.eps}
        \end{minipage}
    }
    \subfigure[\ce{(HAlN^{$i$}Pr)6}的结构]{
        \begin{minipage}[b]{.3\linewidth}
            \centering\includegraphics{picture/(HAlNiPr)6.eps}
        \end{minipage}
    }
    \subfigure[\ce{(MeAlNMe)8}的结构示意图]{
        \begin{minipage}[b]{.3\linewidth}
            \centering\includegraphics{picture/(MeAlNMe)8.eps}
        \end{minipage}
    }\caption{典型的\ce{Al-N}簇的结构}
\end{figure}
\end{document}